...
(custom-set-variables
 ...
 '(package-selected-packages
   '(yasnippet svgo svg-lib emacs-goodies-el marginalia exec-path-from-shell auctex kana dash pdf-tools company vertico gptel use-package macaulay2 cmake-mode)))
(custom-set-faces
